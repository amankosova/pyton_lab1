...
background_top = (218, 216, 113)  # Цвет верхнего уровня фона
background_bottom = (236, 234, 190)  # Цвет нижнего уровня фона
snake_colour = (0, 255, 255)  # Цвет змейки
food_colour = (random.randint(1, 255), random.randint(1, 255), random.randint(1, 255))  # Цвет еды (случайный)
snake_head = (0, 0, 255)  # Цвет головы змейки
